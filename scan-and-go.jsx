  ...
  if (screen === "home") return (
    <div style={{display:"flex",flexDirection:"column",gap:16}} role="main" aria-label="Shopper home screen">
      <div style={{
        ...
        <div style={{color:"#FFFFFFAA",fontSize:11,fontWeight:700,letterSpacing:2,textTransform:"uppercase"}}>Good Morning 👋</div>
          ...
          {cart.map(it => (
            <Card key={it.cid} pad="12px 14px" style={{display:"flex",alignItems:"center",gap:12}}>
              ...
              <div style={{display:"flex",alignItems:"center",gap:6}}>
                <button onClick={() => chgQty(it.cid,-1)} aria-label={`Decrease quantity of ${it.name}`} style={{width:28,height:28,borderRadius:8,background:C.surfaceAlt,border:`1px solid ${C.border}`,color:C.ink,cursor:"pointer",fontWeight:700,fontSize:15,display:"flex",alignItems:"center",justifyContent:"center",fontFamily:"inherit"}}>−</button>
    ...
    <div style={{minHeight:"100vh",background:C.bg,fontFamily:"'Inter','DM Sans',system-ui,sans-serif",color:C.ink}}>
      ...
      >
        <div style={{display:"flex",alignItems:"center",gap:10}}>
          ...
          <div>
            <div style={{fontWeight:900,fontSize:16,fontFamily:"'Plus Jakarta Sans','Inter',sans-serif",letterSpacing:-0.3,color:C.ink}}>ScanGo</div>
